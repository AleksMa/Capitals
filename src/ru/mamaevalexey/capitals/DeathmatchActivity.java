...
public class DeathmatchActivity extends Activity{
	...
	public ArrayList<String> AllCountries = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0; i<MainCountryArray.size(); i++){
    		AllCountries.add(MainCountryArray.get(i).capital);
    	}
    ...
    public void ContinueGame(){
    	...
    	ChooseCountry();
        MakeVariants();
        //Менять количесвто оставшихся стран
    	}	
    	else {
    		if(score!=0)dbManager.addResult(GameName, score);
    		MakeDialog();
    ...
    void MakeDialog(){
    	AlertDialog.Builder builder = new AlertDialog.Builder(DeathmatchActivity.this);
    ...
    public void MakeVariants(){
    	...
    	for(int i=0; i<AllCountries.size(); i++){
    		VarList.add(AllCountries.get(i));
    	}
    	Random r = new Random();
    	for (int i = 0; i < 4; i++) {
